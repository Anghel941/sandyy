...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    document.getElementById('messageContainer').innerHTML = '"¡Ya vez que sí querías! 😂 Lo sabía. Jajajaja, bromita... Sabes que te extraño y quiero verte aunque sea un ratito. 🥹💖';
...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        ...
        case 1:
            ...
            document.getElementById('noBtn').innerHTML = '¡¿Realmente estas segura Sandy!';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
            document.getElementById('sadGifContainer').style.display = 'none';
        ...
        case 4:
            ...
            document.getElementById('noBtn').innerHTML = 'Di que si por favor Sandyy?';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 9:
            ...
            document.getElementById('noBtn').innerHTML = 'Estaré muy muy muy muy triste Sandy';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 10:
            ...
            document.getElementById('noBtn').innerHTML = 'Vale, ya dejaré de preguntar...Sandy';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
